...
function optionalScore(name: string): number | undefined {
...
function resolveInsideWorkspace(workspace: string, input: string, label: string): string {
...
export async function runAction(): Promise<void> {
  try {
    ...
    const outputDirectory = resolveInsideWorkspace(
      workspace,
      core.getInput("output-dir") || "maniflight-report",
      "output-dir",
    );
